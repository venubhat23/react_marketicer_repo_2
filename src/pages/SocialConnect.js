...
const SocialConnect = ({onClose, authCode, authState, socialMediaType}) => {
    ...
    const handleAuthRedirect = (platform) => {
       let authURL = `https://www.facebook.com/v18.0/dialog/oauth?client_id=${FACEBOOK_APP_ID}&redirect_uri=${REDIRECT_URI}&scope=pages_show_list,pages_read_user_content,read_insights,instagram_basic,instagram_manage_insights,instagram_manage_comments,business_management,pages_read_engagement,instagram_content_publish&response_type=code`;
